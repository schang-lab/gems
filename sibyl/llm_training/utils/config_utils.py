...
from sibyl.llm_training.configs import datasets, lora_config, llama_adapter_config, prefix_config, train_config
from sibyl.llm_training.data.sampler import LengthBasedBatchSampler, DistributedLengthBasedBatchSampler
from sibyl.llm_training.datasets import DATASET_PREPROC
...
def generate_dataset_config(train_config, kwargs):
    ...
    if dataset_config.dataset == 'human_simulation': # current training job specific name
